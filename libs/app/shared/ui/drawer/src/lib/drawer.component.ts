...
export class MskDrawerComponent implements OnChanges, OnInit, OnDestroy {
  ...
  @HostBinding('class') get classList(): any {
    return {
      'msk-drawer-animations-enabled': this._animationsEnabled,
      'msk-drawer-fixed': this.fixed,
      'msk-drawer-hover': this._hovered,
      [`msk-drawer-mode-${this.mode}`]: true,
      'msk-drawer-opened': this.opened,
      [`msk-drawer-position-${this.position}`]: true,
    };
  }
  ...
  private _showOverlay(): void {
    ...
    this._overlay.classList.add('msk-drawer-overlay');

    // Add a class depending on the fixed option
    if (this.fixed) {
      this._overlay.classList.add('msk-drawer-overlay-fixed');
    }

    // Add a class depending on the transparentOverlay option
    if (this.transparentOverlay) {
      this._overlay.classList.add('msk-drawer-overlay-transparent');
    }
